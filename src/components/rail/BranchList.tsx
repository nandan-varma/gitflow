...
import { GitBranch, ChevronDown, ChevronRight, Plus, MoreHorizontal, Trash2, Merge } from "lucide-react";
...
function BranchItem({ branch, isRemote = false }: { branch: BranchInfo; isRemote?: boolean }) {
